import { SimpleUser, SimpleUserOptions, SimpleUserDelegate } from "sip.js/lib/platform/web/index.js";
...
const target = process.env.JITSI_SIP_URI;
...
callButton.addEventListener("click", () => {
  callButton.disabled = true;
  hangupButton.disabled = true;
  simpleUser.call(target, { extraHeaders: ['X-Room-Name: FamousFirulette']}).catch((error: Error) => {
